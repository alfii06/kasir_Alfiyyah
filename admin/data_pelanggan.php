            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <body>
                        ...
                        <a href="tambah_pelanggan.php"><button onclick="tambahPelanggan()" class='btn btn-primary'>Tambah Pelanggan</button></a>
                        ...
                        <table id="tabelPelanggan">
                            ...
                            // Query untuk mengambil data pelanggan beserta toko ID dari tabel toko
                            $sql = "SELECT pelanggan.*, toko.nama_toko, toko.toko_id FROM pelanggan
                            LEFT JOIN toko ON pelanggan.toko_id = toko.toko_id";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . ($row["nama_toko"] ?? "Data tidak tersedia") . "</td>";
                                    echo "<td>" . $row["nama_pelanggan"] . "</td>";
                                    echo "<td>" . $row["alamat"] . "</td>";
                                    echo "<td>" . $row["no_hp"] . "</td>";
                                    echo "<td>" . $row["created_at"] . "</td>";
                                    echo "<td>
                                            <a href='edit_data_pelanggan.php?id=" . $row["pelanggan_id"] . "' class='btn btn-success btn-sm'>Edit</a>
                                            <a href='hapus_pelanggan.php?id=" . $row["pelanggan_id"] . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">Delete</a>
                                        </td>";
                                    echo "</tr>";
                                }
                            } else {
                        ...
                        <!-- No need for the JavaScript section -->
