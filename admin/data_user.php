            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <body>
                        ...
                        <a href="tambah_user.php"><button onclick="tambahUser()" class='btn btn-primary'>Tambah User</button></a>
                        ...
                        <table id="tabelUser">
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row["role"] . "</td>";
                                    echo "<td>
                                            <a href='edit_data_user.php?id=" . $row["user_id"] . "' class='btn btn-success btn-sm'>Edit</a>
                                            <a href='hapus_user.php?id=" . $row["user_id"] . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">Delete</a>
                                        </td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='10'>Tidak ada data user.</td></tr>";
                            }
